...
LABEL name="mikefarmer01/devimage-base"
LABEL version="ubi9"
...
LABEL io.k8s.display-name="devimage-base-mikefarmer01"
...
RUN dnf install -y https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm && \
    /usr/bin/crb enable && \
    dnf update -y
RUN dnf install -y bash diffutils git git-lfs iproute jq less lsof man nano procps p7zip p7zip-plugins \
